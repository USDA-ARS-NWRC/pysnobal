			...
			if (output_rec[n]->masked == 1) {
			   ...
			   the routine 'do_data_tstep' modifies them */
				...
				if (first_step == 1) {
					...
					z_s_0		= output_rec[n]->z_s_0;
					z_s_l		= output_rec[n]->z_s_l;
					m_s			= output_rec[n]->m_s;
					m_s_0		= output_rec[n]->m_s_0;
					m_s_l		= output_rec[n]->m_s_l;
					cc_s		= output_rec[n]->cc_s;
					cc_s_0		= output_rec[n]->cc_s_0;
					cc_s_l		= output_rec[n]->cc_s_l;
					h2o_vol		= output_rec[n]->h2o_vol;
					h2o			= output_rec[n]->h2o;
					h2o_max		= output_rec[n]->h2o_max;
					h2o_total	= output_rec[n]->h2o_total;
				}
